...
[Service]
User=node_exporter
#ExecStart=/usr/sbin/node_exporter --web.listen-address=localhost:9111 #uncomment to specify the port 9111
...
ln -s /etc/systemd/system/node_exporter.service /etc/rc2.d/S01node_exporter
